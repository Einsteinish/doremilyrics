...
class RecentResourcesRss(Feed):
    title = "Recent Resources on doremilyrics"
    link = "/resource/"
    description = "Provides feed for recent resources shared on doremilyrics.com"
...
class TopicRecentResourcesRss(Feed):
    ...
    def description(self, obj):
        return "feed for recent resources shared on doremi for %s" %obj.name
