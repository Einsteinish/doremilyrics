...
DISQUS_WEBSITE_SHORTNAME = 'doremi'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'doremi.db',                      # Or path to database file if using sqlite3.
